...
export const P_SECRET_LCD = (process.env['SECRET_LCD'] || 'http://localhost:1317');
export const P_SECRET_RPC = (process.env['SECRET_RPC'] || 'http://localhost:26656');
export const SI_SECRET_CHAIN = process.env['SECRET_CHAIN'] || 'secretdev-1';
export const P_MAINNET_LCD = (process.env['SECRET_MAINNET_LCD'] || 'https://lcd.secret.adrius.starshell.net');
export const X_GAS_PRICE = 0.1;
export const XG_LIMIT_TRANSFER_ORIGINAL = 60000n;
export const SecretWallet = (atu8_sk) => Wallet(atu8_sk, SI_SECRET_CHAIN, P_SECRET_LCD, P_SECRET_RPC, [X_GAS_PRICE, 'uscrt'], 'secret');
export const [atu8_sk_a, atu8_sk_b, atu8_sk_c, atu8_sk_d] = [
...
].map(sb64_sk => base64_to_bytes(sb64_sk));
